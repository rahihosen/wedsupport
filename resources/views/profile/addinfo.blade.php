    ...
    <div class="container">
     ...
     <div class="services">
         ...
         <div class="alert alert-success">
             {{Session::get('success')}} &ensp;
             <button style="background-color: rgb(219, 63, 102)"><a  style="color:rgb(248, 248, 248)" href="{{ route('redirects') }}">Ok</a></button>
     ...
     <form  method="post" action="{{ route('addinfo.store') }}"  enctype="multipart/form-data">
           ...
           <div class="col-sm-6 login_left">
             ...
             <div class="form-group">
                ...
                <input type="date" id="b_date" name="b_date"  class="form-text" plaecholder="M/D/Y"  required>
                @error('b_date')
            ...
            <label for="edit-pass">Address </span></label>
				  <div class="age_grid">
				   <div class="col-sm-6 form_box">
					<div class="select-block1">
					  ...
					  {{-- <select id="country" name="country" required autocomplete="b_date">
			    ...
			    <div class="col-sm-1 form_box2">
					 <div class="select-block1">
                        {{-- <label for="religion">State/Division</span></label>
			  ...
			  <div class="col-sm-4 form_box2">
				   ...
				   <div class="col-sm-4 form_box1">
					 <div class="select-block1">
					  ...
					  <select id="profession" name="profession" required autocomplete="profession">
                        <option value="">Select</option>
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" id="school" name="school" class="form-text " value="{{ old('school') }}" required autocomplete="school">

                </div>
                <div class="form-group">
                    <label for="college">College </label>
                    <input type="text" id="college" name="college" class="form-text @error('college') is-invalid @enderror" value="{{ old('college') }}" required autocomplete="college">
                    @error('college')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="university" name="university" class="form-text @error('university') is-invalid @enderror" value="{{ old('university') }}" required autocomplete="university">
                    @error('university')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subject" name="subject" class="form-text @error('subject') is-invalid @enderror" value="{{ old('subject') }}" required autocomplete="subject">
                    @error('subject')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="height" name="height" class="form-text " value="{{ old('height') }}" >
                    @error('height')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone_number" name="phone_number" class="form-text @error('phone_number') is-invalid @enderror" value="{{ old('phone_number') }}" required autocomplete="phone_number">
                    @error('phone_number')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="weight" name="weight" class="form-text @error('weight') is-invalid @enderror" value="{{ old('weight') }}" required autocomplete="weight">
                    @error('weight')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="place_of_birth" name="place_of_birth" class="form-text " value="{{ old('place_of_birth') }}" >
                </div>
                <div class="form-group">
                    <label for="annual_income">Annual Income :</label>
                    <input type="text" id="annual_income" name="annual_income" class="form-text " value="{{ old('annual_income') }}" >
                </div>

                <div class="form-group">
                    <label for="fathers_occupation">Father's Occupation :</label>
                    <input type="text" id="fathers_occupation" name="fathers_occupation" class="form-text " value="{{ old('fathers_occupation') }}" >
                </div>
                <div class="form-group">
                    <label for="mothers_occupation">Mother's Occupation :</label>
                    <input type="text" id="mothers_occupation" name="mothers_occupation" class="form-text " value="{{ old('mothers_occupation') }}" >
                </div>
                <div class="form-group">
                    <label for="no_of_brother">No. Of Brothers :</label>
                    <input type="text" id="no_of_brother" name="no_of_brother" class="form-text " value="{{ old('no_of_brother') }}" >
                </div>
                <div class="form-group">
                    <label for="no_of_sister">No. Of Sisters :</label>
                    <input type="text" id="no_of_sister" name="no_of_sister" class="form-text " value="{{ old('no_of_sister') }}" >
                </div>
                  ...
                  <label for="edit-pass">Address </label>
                    <div class="age_grid">
                     <div class="col-sm-6 form_box">
                      <div class="select-block1">
                        <label for="religion">Country </span></label>
                        <select onchange="print_state('p_state',this.selectedIndex);" id="p_country" name ="p_country"></select>
             ...
             <div class="row" style="padding: 5px 0px">
              ...
              <div class="form-group">
                  ...
                  <textarea class="form-control" id="comment" name="comment" rows="3" value="{{ old('comment') }}" ></textarea>
              </div>
...
{{--
  ...
  <script language="javascript">print_country("p_country");</script>
  @endsection
