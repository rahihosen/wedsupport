...
$('.like').click(function(){                  
		...
		// $('.like').click(function(){                  
        // var id_stuff = $(this).val();
		// //var like =  <?=  DB::table('likes')->where('id_stuff', 37 )->where('type_action',1)->count('id_stuff'); ?>
    ...
    <!--<div class="navbar navbar-inverse-blue navbar-fixed-top">-->
      <div class="navbar-inner">
        <div class="container">
		   ...
		   <div class="col-md-1">
			<a style="margin-left: -86px;" class="brand" href="{{ route("index") }}"><img src= "{{asset('assets/images/logo.png')}}"  alt="logo" style="height: 40px; width: 60px;">
			</a>
		   </div>
			 ...
			 <!-- Collect the nav links, forms, and other content for toggling -->
			  <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
				  <ul class="nav navbar-nav nav_1">
					  <li><a style="color:rgb(255, 255, 255); font-weight:bold"  href="{{ route("index") }}">Home</a></li>
					  <li><a style="color:rgb(255, 255, 255); font-weight:bold"  href="{{ route("about") }}">About</a></li>
  
					  <li class="last"><a style="color:rgb(255, 255, 255); font-weight:bold"  href="{{ route("contact") }}">Contacts</a></li>
					  ...
					  <li class="dropdown">
						  <a style="color:rgb(252, 247, 247); font-weight:bold" href="#" class="dropdown-toggle " data-toggle="dropdown">{{ Auth::user()->name }}<span class="caret"></span></a>
						  <ul class="dropdown-menu" role="menu">
							  <li>
								  <a style="color:rgb(255, 255, 255); font-weight:bold"   href="{{ route('information') }}">Profile</a>
							  ...
							  <li>
								  <a style="color:rgb(255, 255, 255); font-weight:bold" href="{{ route('updateinfo') }}">Update Information</a>
  
							  </li>
							  <li>
								  <a style="color:rgb(255, 255, 255); font-weight:bold"   href="{{ route('setting') }}">Setting</a>
							  </li>
							  <li>
								  <a style="color:rgb(253, 252, 252); font-weight:bold"   href="{{ route('photos') }}">Photos Gallery</a>
					  ...
					  <li>
						<li class="dropdown">
							<a style="color:rgb(252, 247, 247); font-weight:bold" href="#" class="dropdown-toggle " data-toggle="dropdown">Activity<span class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li>
									<a style="color:rgb(255, 255, 255); font-weight:bold"   href="{{ route('likepage') }}">likes</a>
	
								</li>
								<li>
									<a style="color:rgb(255, 254, 254); font-weight:bold" href="{{ route('fvrtpage') }}">Favourites</a>
					  ...
					  <li><a style="color:rgb(253, 251, 251); font-weight:bold"   href="{{ route('logout') }}">Logout</a></li>
		  ...
		  <div class="col-md-4 sticky-right" style="padding-left: 0px; padding-right: 0px;">
...
<ul class="nav nav-tabs" style="background-color: #524b4b">
	<li class="active"><a data-toggle="tab" href="#home">Viewed My profile</a></li>
	<li><a data-toggle="tab" href="#menu1">Profile I viewed</a></li>
...
height: 141px; width: 138px;padding: 10px;border-radius: 95px;margin-top: 20px;
.membersp{
    font-size: 14px;
    padding-bottom: 10px
}
