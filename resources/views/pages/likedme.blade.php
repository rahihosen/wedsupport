...
<body>
				...
				<div class="container-fluid">
				  ...
				  <ul class="nav navbar-nav11">
                    ...
                    <div style="float: left;" class="upgrade">
                        ...
                        <div style="float: left; display:none;"><i class="fas fa-arrow-circle-up"></i></div>


                        <div style="float: left; display:none;" class="up-text">
                    ...
                    <div style="float: left; display:none;" class="tham"><i class="fas fa-cog"></i> </div>
    ...
    <ul class="nav nav-tabs" style="background-color: #524b4b">
        <li class="active"><a data-toggle="tab" href="#home">Liked Me</a></li>
        <li><a data-toggle="tab" href="#menu1">My Likes</a></li>
        <!--<li><a data-toggle="tab" href="#menu2">Mutual Likes</a></li>-->
    ...
    <div class="container">
        ...
        <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
                ...
                @foreach ($likedMeProfileID as $data)
     ...
     ->value('to_age') ?> <br>
            ...
            <div id="menu1" class="tab-pane fade">
                ...
                @foreach ($mylikedprofileID as $data)
