    ...
    <x-jet-authentication-card>
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="passport" class="block mt-1 w-full" type="text" name="passport" :value="old('passport')" required />
            </div>

            <div class="mt-4">
                <x-jet-label for="nid copy" value="{{ __('Nid Copy') }}" />
                <x-jet-input id="nid_copy" class="block mt-1 w-full" type="file" name="nid_copy" :value="old('nid_copy')" required />
            </div>   
