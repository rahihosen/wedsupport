<?php $__env->startSection('content'); ?>
    ...
    <!--	<img src="<?php echo e(asset('assets/images/slide1.jpg')); ?>" alt="" width="100%">-->
    <!--	</div>-->

    <!-- Slide 2 -->
    <!--	<div class="item">-->
    <!--	<img src="<?php echo e(asset('assets/images/slide2.jpg')); ?>" alt="" width="100%">-->
    <!--	</div>-->

    <!-- Slide 3 -->
    <!--	<div class="item">-->
    <!--	<img src="<?php echo e(asset('assets/images/slide3.jpg')); ?>" alt="" width="100%">-->
    <!--	</div>-->
    <!--	<div class="item">-->
    <!--		<img src="<?php echo e(asset('assets/images/slide4.jpg')); ?>" alt="" width="100%">-->
    <!--	</div>-->
    <!--	<div class="item">-->
    <!--			<img src="<?php echo e(asset('assets/images/slide5.jpg')); ?>" alt="" width="100%">-->
    <!--	</div>-->
        ...
        <div class="container-fluid" style="padding:5em 0;  background-color:rgba(155, 152, 153, 0.29);">
            ...
            <div class="container">
                <div class="col-md-3 col-xs-6 col_2_love">
                    ...
                    <img src="<?php echo e(asset('assets/images/13.jpg')); ?>">
            ...
            <div class="flexbox">
                ...
                <div class="flex-item"><a href="<?php echo e(route('testimonial')); ?>" class="hvr-shutter-out-horizontal"
        ...
        <div class="grid_1" style="padding: 1em 0">
            ...
            <div class="container">
                ...
                <div class="col-md-4 col_2 how_it_work">
                    <img src="<?php echo e(asset('assets/images/hiw1.png')); ?>" alt="">
                ...
                <div class="col-md-4 col_2 how_it_work">
                    <img src="<?php echo e(asset('assets/images/hiw2.png')); ?>" alt="">
                ...
                <div class="col-md-4 col_2 how_it_work">
                    <img src="<?php echo e(asset('assets/images/hiw3.png')); ?>" alt="">
 ...
 <br><br><br>
    ...
    <div class="grid_1" style="padding-top: 50px">
        <div class="container">
            ...
            <ul id="flexiselDemo3">
                <?php $__currentLoopData = $feather_profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                    <div class="col_1">
                        <a href="#">
                            <img src="<?php echo e(asset('userImage/'.$row->userProfile->imagePath)); ?>" alt=""
                                class="hover-animation image-zoom-in img-responsive" style="height: 150px !important" onerror="this.src='<?php echo e(asset('assets/images/avatar.png')); ?>'" />
                            <div class="layer m_1 hidden-link hover-animation delay1 fade-in">
                                <div class="center-middle"><?php echo e($row->name); ?></div>
                            </div>
                            <h3><span class="m_3">Profile ID : WS- 001<?php echo e($row->id); ?></span><br><?php echo e($row->userProfile->state); ?>,
                                <?php echo e($row->userProfile->country); ?><br><?php echo e($row->userProfile->profession); ?></h3>
                        </a>
                    </div>
                </li>
                ...
                <!--            <img src="<?php echo e(asset('assets/images/avatar.png')); ?>" alt=""-->
   ...
   <div class="bg">
		  <div class="container">
			  ...
			  <div class="col-sm-6">
				  <div class="bg_left">
					  <h5>From :  <?php echo e($row->user->name); ?></h5>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\wed\resources\views/pages/index.blade.php ENDPATH**/ ?>